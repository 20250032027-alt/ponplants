  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px 96px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 64 }} className="two-col">
        <div>
          <h2 style={{ fontFamily: 'Lora, Georgia, serif', fontSize: '1.6rem', fontWeight: 700, color: 'var(--text-1)', marginBottom: 16 }}>Getting started</h2>
        ...
        <div>
          <h2 style={{ fontFamily: 'Lora, Georgia, serif', fontSize: '1.6rem', fontWeight: 700, color: 'var(--text-1)', marginBottom: 16 }}>Common problems</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              <div key={i} style={{ padding: '14px 18px', borderRadius: 12, backgroundColor: 'var(--surface)', border: '1px solid #e7e3dc' }}>
                <p style={{ fontWeight: 700, color: 'var(--text-1)', fontSize: 13, marginBottom: 4 }}>{item.issue}</p>
                <p style={{ fontSize: 13, color: 'var(--text-3)', lineHeight: 1.5, margin: 0 }}>{item.cause}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
        ...
        <Link href="/leca-vs-pon" style={{ padding: '13px 24px', borderRadius: 12, backgroundColor: 'var(--surface-2)', border: '1px solid #e8e4de', color: 'var(--text-1)', fontWeight: 500, fontSize: 14, textDecoration: 'none' }}>LECA vs Pon comparison</Link>
      </div>
